...
//   ctx.res.end(htmlStr)
// })
};var history=Object(history__WEBPACK_IMPORTED_MODULE_13__["createMemoryHistory"])({initialEntries:[ctx.req.url]});var serverApp=dva__WEBPACK_IMPORTED_MODULE_5___default()({history:history});serverApp.model(__webpack_require__(/*! ./model/video */ "./src/model/video.js").default);serverApp.router(function(history){return react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(dva_router__WEBPACK_IMPORTED_MODULE_8__["StaticRouter"],{location:ctx.req.url,context:context,history:history},react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(_App__WEBPACK_IMPORTED_MODULE_10__["default"],null));});var markup=Object(react_dom_server__WEBPACK_IMPORTED_MODULE_6__["renderToString"])(serverApp.start());console.log('mark',markup);var html=nunjucks__WEBPACK_IMPORTED_MODULE_7___default.a.renderString(template,{data:JSON.stringify(data),markup:markup});// 将渲染后的html字符串发送给客户端
