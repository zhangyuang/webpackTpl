...
/*#__PURE__*/
function (_Component) {
  Object(_Users_zhangyuang_Desktop_github_bigview_react_ssr_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_4__["default"])(App, _Component);

  function App() {
    Object(_Users_zhangyuang_Desktop_github_bigview_react_ssr_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, App);

    return Object(_Users_zhangyuang_Desktop_github_bigview_react_ssr_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2__["default"])(this, Object(_Users_zhangyuang_Desktop_github_bigview_react_ssr_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3__["default"])(App).apply(this, arguments));
  }

  Object(_Users_zhangyuang_Desktop_github_bigview_react_ssr_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(App, [{
    key: "render",
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(dva_router__WEBPACK_IMPORTED_MODULE_6__["Switch"], null, _router__WEBPACK_IMPORTED_MODULE_7__["default"].map(function (_ref) {
        var path = _ref.path,
            exact = _ref.exact,
            Component = _ref.component;
        return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(dva_router__WEBPACK_IMPORTED_MODULE_6__["Route"], {
          key: path,
          path: path,
          exact: exact,
          component: Component
...
/*#__PURE__*/
function (_Component) {
  Object(_Users_zhangyuang_Desktop_github_bigview_react_ssr_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_4__["default"])(Video, _Component);

  function Video() {
    Object(_Users_zhangyuang_Desktop_github_bigview_react_ssr_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, Video);

    return Object(_Users_zhangyuang_Desktop_github_bigview_react_ssr_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2__["default"])(this, Object(_Users_zhangyuang_Desktop_github_bigview_react_ssr_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3__["default"])(Video).apply(this, arguments));
  }

  Object(_Users_zhangyuang_Desktop_github_bigview_react_ssr_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Video, [{
    ...
    key: "initPlayer",
    value: function initPlayer(videoArr) {
      var _this = this;

      if (videoArr.length === 0) return;
      videoArr.map(function (item) {
        var vid = item.itemResult.item[1].preview.vid;
        if (!vid) return false;
        var config = {
          id: 'youku-player',
          vid: vid,
          ...
          events: {
            onPlayStart: _this.wifiPlayH5,
            onAdPlayStart: _this.onPlayH5,
            onPlayEnd: _this.onPlayEnd,
            onMediaSrcOK: _this.onMediaSrcOK,
            onPlay: _this.onPlayH5,
            onReady: _this.onReadyH5
          }
        };
        var uiConfig = {
          dash: {
    ...
    key: "render",
    value: function render() {
      var videoArr = this.props.videoArr;
      return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div", {
        className: "video-container"
      }, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div", {
        id: "playerWrap"
      }, videoArr.map(function (item, index) {
        return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div", {
          key: "video".concat(index)
        }, item.template.tag !== 'PHONE_AD_B' ? react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div", {
          className: "player",
          id: item.itemResult.item[1].preview.vid
        }), react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div", {
          className: "player-footer"
        }, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div", {
          className: "author"
        }, item.itemResult.item[1].uploader.name.length > 6 ? item.itemResult.item[1].uploader.name.slice(0, 6) + '...' : item.itemResult.item[1].uploader.name), react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div", {
          className: "comment"
        }, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("img", {
          alt: "",
          className: "wifi-img",
          src: "https://img.alicdn.com/tfs/TB1.XkGkxTpK1RjSZR0XXbEwXXa-72-72.png"
        }), react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("span", {
          className: "comment-count"
        }, item.itemResult.item[1].comments.count)))) : '');
      })));
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (Object(dva__WEBPACK_IMPORTED_MODULE_6__["connect"])(mapStateToProps)(Video));
...
module.exports = __webpack_require__.p + "static/media/video.82663af3.css";
...
var template = fs__WEBPACK_IMPORTED_MODULE_0___default.a.readFileSync(path__WEBPACK_IMPORTED_MODULE_1___default.a.resolve('./dist/template.html'), 'utf-8').toString();
var app = new koa__WEBPACK_IMPORTED_MODULE_2___default.a();
var serverRouter = new koa_router__WEBPACK_IMPORTED_MODULE_3___default.a();
app.use(koa_static__WEBPACK_IMPORTED_MODULE_11___default()('dist'));

var render = function render(ctx, next) {
  var activeRoute = _src_router__WEBPACK_IMPORTED_MODULE_12__["default"].find(function (route) {
    return Object(dva_router__WEBPACK_IMPORTED_MODULE_8__["matchPath"])(ctx.req.url, route);
  }) || {};
  var promise = activeRoute.fetchInitialData ? activeRoute.fetchInitialData(ctx.req.path) : Promise.resolve();
  promise.then(function (data) {
    var context = {
      data: data // const stream = renderToNodeStream(
    ...
    var serverApp = dva__WEBPACK_IMPORTED_MODULE_5___default()({
      history: history
    });
    serverApp.model(__webpack_require__(/*! ./model/video */ "./src/model/video.js").default);
    serverApp.router(function (history) {
      return react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(dva_router__WEBPACK_IMPORTED_MODULE_8__["StaticRouter"], {
        location: ctx.req.url,
        context: context,
        history: history
      }, react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(_App__WEBPACK_IMPORTED_MODULE_10__["default"], null));
    });
    var markup = Object(react_dom_server__WEBPACK_IMPORTED_MODULE_6__["renderToString"])(serverApp.start());
    var html = nunjucks__WEBPACK_IMPORTED_MODULE_7___default.a.renderString(template, {
      data: data,
      markup: markup
    }); // 将渲染后的html字符串发送给客户端
...
var video = [{
  ...
  'template': {
    'tag': 'PHONE_FEED_OGC_SURROUND_SINGLE'
  }
}, {
  'itemResult': {
    'item': {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  reducers: {
    saveVideo: function saveVideo(state, action) {
      return Object(_Users_zhangyuang_Desktop_github_bigview_react_ssr_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, state, action.payload);
    }
  },
  effects: {
    get:
    /*#__PURE__*/
    _Users_zhangyuang_Desktop_github_bigview_react_ssr_node_modules_babel_preset_react_app_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function get(_ref, _ref2) {
      var payload, call, put, videoArr;
      return _Users_zhangyuang_Desktop_github_bigview_react_ssr_node_modules_babel_preset_react_app_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function get$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return call(_services_video__WEBPACK_IMPORTED_MODULE_2__["getVideo"]);

            case 4:
              videoArr = _context.sent;
              _context.next = 7;
              return put({
                type: 'saveVideo',
                payload: {
...
var routes = [{
  path: '/',
  exact: true,
  component: _components_video__WEBPACK_IMPORTED_MODULE_0__["default"]
}];
...
var getVideo = function getVideo() {
  return new Promise(function (resolve) {
    // 模拟异步调用
    setTimeout(function () {
      resolve(_mock_video__WEBPACK_IMPORTED_MODULE_0__["default"]);
    }, 1000);
  });
};
