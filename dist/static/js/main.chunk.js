...
var Video=/*#__PURE__*/function(_Component){Object(_Users_zhangyuang_Desktop_github_bigview_react_ssr_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_4__["default"])(Video,_Component);function Video(props){var _this;Object(_Users_zhangyuang_Desktop_github_bigview_react_ssr_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this,Video);_this=Object(_Users_zhangyuang_Desktop_github_bigview_react_ssr_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2__["default"])(this,Object(_Users_zhangyuang_Desktop_github_bigview_react_ssr_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3__["default"])(Video).call(this,props));console.log(window.__INITIAL_DATA__);if(window&&window.__INITIAL_DATA__){_this.props.videoArr=window.__INITIAL_DATA__;}return _this;}Object(_Users_zhangyuang_Desktop_github_bigview_react_ssr_node_modules_babel_preset_react_app_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Video,[{key:"componentDidMount",value:function componentDidMount(){// this.getVideo()
}},{key:"prefetch",value:function prefetch(){console.log(this.props.dispatch,'xxx');return this.props.dispatch({type:'video/get',payload:{}});}},{key:"getVideo",value:function getVideo(){this.props.dispatch({type:'video/get',payload:{}});}},{key:"initPlayer",value:function initPlayer(videoArr){var _this2=this;if(videoArr.length===0)return;videoArr.map(function(item){var vid=item.itemResult.item[1].preview.vid;if(!vid)return false;var config={id:'youku-player',vid:vid,client_id:'1c9aa3003b83b3b2',events:{onPlayStart:_this2.wifiPlayH5,onAdPlayStart:_this2.onPlayH5,onPlayEnd:_this2.onPlayEnd,onMediaSrcOK:_this2.onMediaSrcOK,onPlay:_this2.onPlayH5,onReady:_this2.onReadyH5}};var uiConfig={dash:{// 控制栏按钮隐藏配置
full:true// 是否隐藏全屏按钮
}};return window.YKPlayer.Player(vid,config,uiConfig);});}},{key:"componentDidUpdate",value:function componentDidUpdate(){this.initPlayer(this.props.videoArr);}},{key:"render",value:function render(){var videoArr=this.props.videoArr;return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div",{className:"videoContainer"},react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div",{id:"playerWrap"},videoArr.map(function(item,index){return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div",{key:"video".concat(index)},item.template.tag!=='PHONE_AD_B'?react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div",null,react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div",{className:"player",id:item.itemResult.item[1].preview.vid}),react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div",{className:"player-footer"},react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div",{className:"author"},item.itemResult.item[1].uploader.name.length>6?item.itemResult.item[1].uploader.name.slice(0,6)+'...':item.itemResult.item[1].uploader.name),react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div",{className:"comment"},react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("img",{alt:"",className:"wifi-img",src:"https://img.alicdn.com/tfs/TB1.XkGkxTpK1RjSZR0XXbEwXXa-72-72.png"}),react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("span",{className:"comment-count"},item.itemResult.item[1].comments.count)))):'');})));}}]);return Video;}(react__WEBPACK_IMPORTED_MODULE_5__["Component"]);var mapStateToProps=function mapStateToProps(state){return{videoArr:state.video.videoArr};};/* harmony default export */ __webpack_exports__["default"] = (Object(dva__WEBPACK_IMPORTED_MODULE_6__["connect"])(mapStateToProps)(Video));
...
var app=dva__WEBPACK_IMPORTED_MODULE_2___default()({browserHistory:dva_router__WEBPACK_IMPORTED_MODULE_3__["browserHistory"]});// 2. Plugins
// app.use({});
// 3. Model
app.model(__webpack_require__(/*! ./model/video */ "./src/model/video.js").default);// 4. Router
app.router(function RouterConfig(_ref){var history=_ref.history;return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(dva_router__WEBPACK_IMPORTED_MODULE_3__["Router"],{history:history},react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_App__WEBPACK_IMPORTED_MODULE_4__["default"],null));});var Start=app.start();react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Start,null),document.getElementById('app'));
...
var getVideo=function getVideo(){return new Promise(function(resolve){// 模拟异步调用
